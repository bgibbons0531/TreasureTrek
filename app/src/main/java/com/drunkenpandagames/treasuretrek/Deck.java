...
public class Deck {
    ...
    private void fillDeck() {
        cards[0] = new Card(0, "First Aid", "firstAid",
        ...
        cards[6] = new Card(6, "Bee Hive", "beeHive",
                new Option(6, "Go under<br>-2 Health", -2, 0, 0),
                new Option(6, "Go around<br>-2 Energy", 0, -2, 0));
        cards[7] = new Card(7, "Skeleton Ambush", "spookyScarySkeleton",
        ...
        cards[22] = new Card(22, "Adventurer Under Attack", "guyInTrouble",
                new Option(22, "Keep<br>walking<br>-2 Sanity", 0, 0, -2),
                new Option(22, "Intervene<br><br>-2 Health", -2, 0, 0));
        cards[23] = new Card(23, "Giant Spider", "bigOlSpider",
